  ...
  return (
    <section>
      ...
      <div className="parent-notes">
        ...
        <article>
          <h2>Прогресс</h2>
          <p>Звёзды даются за правильный ответ с первой попытки. Ошибки помогают игре чаще повторять сложные буквы.</p>
        </article>
        <article>
          <h2>Повторение</h2>
          <p>Игра выбирает не только случайные буквы: новые и трудные буквы появляются чаще, освоенные — реже.</p>
        </article>
        <article>
          <h2>Аудио</h2>
